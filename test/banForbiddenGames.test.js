const {concatGuildsOnlineMember} = require('../ban-forbidden-games');
const assert = require('chai').assert;

describe('concatGuildsOnlineMember', () => {
	it('should return the same array with only one map collection', () => {
	...
	it('should return the same when multiple map collection', () => {
		const testArray = ['this', 'is', 'a', 'test'];
		const map1 = new Map([
			['test1', 'this'],
		],
