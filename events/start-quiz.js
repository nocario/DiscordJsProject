...
//----------------------------------------------------------------------------------------------------------------------
const QUESTION_INTERVAL = 15_000;
const TIME_MAX = 10_000;
let participants = {};
const reactions = ['💛', '💚', '💙', '💜'];
//----------------------------------------------------------------------------------------------------------------------
const diff = (a, b) => a[1] - b[1];
...
const addReactions = embed => R.forEach(reaction => {
...
const createQuestionEmbed = description => async (results, interaction) => await sendEmbed(createEmbed_(`\n✨ ${R.prop('question', results)} ✨ \n`, description), interaction);
...
const collector = embed => embed.createReactionCollector({filter, time: TIME_MAX});
